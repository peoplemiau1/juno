...
В Juno v2.1 введена система автоматического аудита владения ресурсами. Это уникальная фича, которая предотвращает утечки памяти и `use-after-free` на этапе компиляции.
