module SyscallMapper
  SYSCALLS = {
    ...
    time:     { x86_64: 201, aarch64: 169 },
    memfd_create: { x86_64: 319, aarch64: 279 },
    epoll_create: { x86_64: 213, aarch64: 20 },
  ...
  def emit_syscall(name)
    ...
    if @arch == :aarch64
      ...
      @emitter.emit([0xb8] + [id].pack("L<").bytes)
      @emitter.syscall
    end
  end
end
